...
![Sample](IMAGE/mongodb%20practice%201.PNG)
...
db.movies.find()
```
![Sample](IMAGE/mongodb%20practice%202.PNG)

2. get all documents with `writer` set to "Quentin Tarantino"
```
db.movies.find({writer:"Quentin Tarantino"})
```
![Sample](IMAGE/mongodb%20practice%203.PNG)

3. get all documents where `actors` include "Brad Pitt"
```
db.movies.find({actors:"Brad Pitt"})
```
 ![Sample](IMAGE/mongodb%20practice%204.PNG)
 
4. get all documents with `franchise` set to "The Hobbit"
```
db.movies.find({franchise:"The Hobbit"})
```
![Sample](IMAGE/mongodb%20practice%205.PNG)

5. get all movies released in the 90s
```
db.movies.find({year:{$gt:"1990", $lt:"2000"}})
```
![Sample](IMAGE/6.5.JPG)

6. get all movies released before the year 2000 or after 2010
```
db.movies.find({$or:[{year:{$gt:"2010"}},{year: {$lt:"2000"}}]})
```
![Sample](IMAGE/6.6.JPG)
