...
DELIMITER //
CREATE PROCEDURE new_procedure (In Old_Name VARCHAR(100))
BEGIN
UPDATE vendors 
...
SELECT * FROM Products_Price_Range;
...
CREATE PROCEDURE update_vendor_name(IN BrysonInc VARCHAR(100))
BEGIN
    UPDATE vendors 
    SET v_name = 'Bryson and Co'
    WHERE v_name ='Bryson,Inc.';
...
DELIMITER ;
CALL update_vendor_name('Bryson and Co');

CALL new_procedure('Bryson,Inc.');